export const clubRules = [
  {
    title: "Reservas desde las 22:00",
    description:
      "Los turnos del dia siguiente se habilitan a las 22:00 para que todos tengan la misma ventana de reserva."
  },
  {
    title: "Una reserva confirmada por dia",
    description:
  ...
  },
  {
    ...
    description:
      "La app concentra calendario, transmisiones, mensajes privados y partidos casuales dentro del ecosistema del club."
  }
];
...
export const clubHighlights = [
  {
    ...
    description:
      "Seguimiento de Cancha 1 y Cancha 2 en simultaneo con YouTube y marcador automatico."
  },
  {
    title: "Partidos casuales",
    description:
      "Historial entre jugadores, ranking amistoso y busqueda de rival por categoria."
  },
  {
    title: "Torneos del circuito",
    description:
      "Fechas destacadas, links oficiales y tablero especial para eventos del club."
  }
];
